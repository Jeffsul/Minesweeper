...
public class MineField {		
	...
	private static class MineButton extends JButton {	
		...
		private static final Color[] COLOURS = {Color.BLACK, Color.BLUE, Color.getHSBColor(0.333f, 0.777f, 0.439f),
		  Color.RED, Color.ORANGE, Color.MAGENTA, Color.CYAN, Color.BLACK};
